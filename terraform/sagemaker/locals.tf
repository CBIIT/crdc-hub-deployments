locals {
  ...
  sagemaker_studio_role_name = var.target_account_cloudone ? "${var.iam_prefix}-${var.resource_prefix}-sagemaker-studio-execute-role" : "${var.resource_prefix}-sagemaker-studio-execute-role"
  ...
  sagemaker_instance_admin_role_policy_name = var.target_account_cloudone ? "${var.iam_prefix}-${var.resource_prefix}-sagemaker-instance-admin-role-policy" : "${var.resource_prefix}-sagemaker-instance-admin-role-policy"
  ...
  sagemaker_canvas_execution_policy_name = var.target_account_cloudone ? "${var.iam_prefix}-${var.resource_prefix}-sagemaker-canvas-bedrock-role-policy" : "${var.resource_prefix}-sagemaker-canvas-bedrock-role-policy"
